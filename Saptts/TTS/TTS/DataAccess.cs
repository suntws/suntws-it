...
namespace TTS
{
    ...
    {
        private string _Con = ConfigurationManager.ConnectionStrings["TTSDB"].ConnectionString;
        ...
        public object ExecuteReader_WithOUTPUT_SP(string SpName, ref SqlParameter[] SpParams, Return_Type RetType)
        {
            SqlConnection connection = new SqlConnection(_Con);
            SqlCommand cmd = new SqlCommand();
            DataSet ds = new DataSet();
