<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="prospectreview.aspx.cs" Inherits="TTS.prospectreview" EnableEventValidation="false" %>
                    ...
                    <td>
                        <table cellspacing="0" rules="all" border="1" class="tableCust">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList runat="server" ID="ddlLeadList" CssClass="ddlchange" ClientIDMode="Static"
                                        Width="170px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(CustName, country, City, flag, port, focus, Lead, Supplier, LeadSource) {
            ...
            if (supplierhistory != '') {
                $.ajax({
                    type: "POST",
                    url: 'BindRecords.aspx?type=GetReviewAll&CustName=' + CustName + '&country=' + country1 + '&City=' + City1 + '&flag=' + flag + '&port=' + port + '&focus=' + focus1 + '&Lead=' + Lead + '&Supplier=' + Supplier + '&LeadSource=' + LeadSource + '',
                    ...
                    success: function OnSuccess(response) {
                        ...
                        $("#jqGrid").jqGrid({
                            ...
                            data: mydata,
                            styleUI: 'Bootstrap',
                            colNames: ['', 'CODE', 'CUSTOMER NAME', 'CITY', 'COUNTRY', 'PORT', 'LEAD SOURCE', 'FOCUS', 'FLAG', 'LEAD', 'SUPERVISOR', 'MANAGER', 'SUPPLIER', 'LAST FEEDBACK FROM LEAD'],
                            colModel: [
                    ...
                    { name: 'leadfeedback', lable: 'leadfeedback', width: 220, resizable: false, formatter: leadFeedBack }
        ...
        function SelectSingleReview(rdBtnID) {
            ...
            TINY.box.show({ iframe: 'prospectpopup.aspx?custcode=' + rdBtnID + '&qstr=prospectreview&focus=' + focus + '&flag=' + flag + '&querystr=' + querystr, boxid: 'frameless', width: 1000, height: 600, fixed: false, maskid: '#57565A', maskopacity: 40, closejs: function () { } })
        }
    </script>
</asp:Content>
