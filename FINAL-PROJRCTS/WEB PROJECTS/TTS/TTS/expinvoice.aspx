...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <td>
                    <asp:GridView runat="server" ID="gvInvoiceMakeList" AutoGenerateColumns="false" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="CUSTOMER DispatchedDate" DataField="DispatchedDate"
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <asp:DropDownList ID="ddlExpAuthorizedAddress" ClientIDMode="Static" runat="server"
                                                    Width="850px" CssClass="form-control">
                                                </asp:DropDownList>
                                            </td>
                                            ...
                                            <td>
                               <asp:TextBox   runat="server" ID="vesselname" ClientIDMode="Static" Text="" Width="100px"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                Date:
                                                <asp:TextBox runat="server" ID="txtInvoiceDate" ClientIDMode="Static" Text ="" Width="300px" MaxLength="100" CssClass="form-control">  </asp:TextBox>
                                                <asp:Label runat="server" ID="lblInvoiceDate" ClientIDMode="Static" Text="" Width="100px"></asp:Label>
                                            </td>
                                            <th>
                                                BILL OF LADING NO
                                            </th>
                                            <td>
                                                <asp:TextBox runat="server" ID="BILLOFLADING" ClientIDMode="Static" Text="" Width="90px"
                                                    MaxLength="60" CssClass="form-control"></asp:TextBox>
                                            ...
                                            <td>
                                                <asp:DropDownList runat="server" ID="ddlContainerType" ClientIDMode="Static" Width="100px"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList runat="server" ID="ddlPriceBasis" ClientIDMode="Static" Width="90px"
                                                    CssClass="form-control">
                                            ...
                                            <td>
                                                <asp:TextBox runat="server" ID="containerno" ClientIDMode="Static" Text="" Width="100px"
                                                    MaxLength="100" CssClass="form-control"></asp:TextBox>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox runat="server" ID="txtPriceBasisContent" ClientIDMode="Static" Text=""
                                                    Width="90px" MaxLength="20" CssClass="form-control"></asp:TextBox>
                                            </td>
                                            <th>
                                            Container SEAL NO
                                            </th>
                                            <td>
                                                <asp:TextBox runat="server" ID="SERIALNO" ClientIDMode="Static" Text=""
                                                    Width="100px" MaxLength="20" CssClass="form-control"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>
                                            ...
                                            <td>
                                                <asp:DropDownList runat="server" ID="ddlPortLoading" ClientIDMode="Static" Width="265px"
                                                    ...
                                                    <asp:ListItem Text="ENNORE, INDIA" Value="INDIA"></asp:ListItem>
                                                    <asp:ListItem Text="KATTUPALLI, INDIA" Value="INDIA"></asp:ListItem>
                                                    <asp:ListItem Text="THOOTHUKUDI, INDIA" Value="INDIA"></asp:ListItem>
                                            ...
                                            <td>
                                                <asp:DropDownList runat="server" ID="ddlPlaceofReceipt" ClientIDMode="Static" Width="90px"
                                                    CssClass="form-control">
                                            ...
                                            <td>
                                                <asp:TextBox runat="server" ID="finaldestination" ClientIDMode="Static" Text=""
                                                    Width="100px" MaxLength="20" CssClass="form-control"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
  ...
  <script type="text/javascript">
      $(function () {
          ...
          $("#txtInvoiceDate").datepicker().keydown(function (e) { e.KeyWhich = 0; e.KeyCode = 0; e.preventDefault(); });
      });
