<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="expscanpdi.aspx.cs" Inherits="TTS.expscanpdi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                        ...
                        <ContentTemplate>
                            ...
                            <div style="width: 100%; float: left;">
                                <table cellspacing="0" rules="all" border="1" class="tbMas">
                                    ...
                                    <tr>
                                        <td colspan="8">
                                            <asp:GridView runat="server" ID="gv_BarcodeMatchedItems" AutoGenerateColumns="false"
                                                Width="100%">
                                                <Columns>
                                                    <asp:BoundField HeaderText="PLATFORM" DataField="config" />
                                                    <asp:BoundField HeaderText="TYRE SIZE" DataField="tyresize" />
                                                    <asp:BoundField HaderText="RIM" DataField="rimsize" />
                                                    ...
                                                    <asp:BoundField HeaderText="INSPECTED QTY" DataField="inspectqty" ItemStyle-HorizontalAlign="Right" />
                                                    <asp:TemplateField HeaderText="ASSIGN TO">
                                                        <ItemTemplate>
                                                            <asp:RadioButton ID="rdbAssignTo" runat="server" onclick="javascript:CheckOtherIsCheckedByGVID(this);" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
    ...
    <script type="text/javascript">
        ...
        function CheckOtherIsCheckedByGVID(spanChk) {
            ...
            var Chk = spanChk;
            Parent = document.getElementById("<%=gv_BarcodeMatchedItems.ClientID%>");
