<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="prospectreviewdomestic.aspx.cs" Inherits="TTS.prospectreviewdomestic" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.ddlchange').change(function () { GetCustomers($("#ddlCustList option:selected").text(), $("#ddlCity option:selected").text(), $("#ddlFlagList option:selected").text(), $("#ddlPort option:selected").text(), $("#ddlFocusList option:selected").text(), $("#ddlLeadList option:selected").text(), $("#ddlSupplier option:selected").text(), $("#ddlLeadSource option:selected").text()); });
        });
        function gridbind() { GetCustomers($("#ddlCustList option:selected").text(), $("#ddlCity option:selected").text(), $("#ddlFlagList option:selected").text(), $("#ddlPort option:selected").text(), $("#ddlFocusList option:selected").text(), $("#ddlLeadList option:selected").text(), $("#ddlSupplier option:selected").text(), $("#ddlLeadSource option:selected").text()); }

        function GetCustomers(CustName, City, flag, port, focus, Lead, Supplier, LeadSource) {
            supplierhistory = '';
            ...
            if (supplierhistory != '') {
                $.ajax({
                    type: "POST",
                    url: 'BindRecords.aspx?type=Getreviewdom&CustName=' + CustName + '&City=' + City1 + '&flag=' + flag + '&port=' + port + '&focus=' + focus1 + '&Lead=' + Lead + '&Supplier=' + Supplier + '&LeadSource=' + LeadSource + '',
                    ...
                    success: function OnSuccess(response) {
                        ...
                        $("#jqGrid").jqGrid({
                            ...
                            data: mydata,
                            styleUI: 'Bootstrap',
                            colNames: ['', 'CODE', 'CUSTOMER NAME', 'CITY', 'PORT', 'LEAD SOURCE', 'FOCUS', 'FLAG', 'LEAD', 'SUPERVISOR', 'MANAGER', 'SUPPLIER', 'LAST FEEDBACK FROM LEAD'],
                            colModel: [
                    ...
                    { name: 'City', width: 110, resizable: false },
                    { name: 'port', width: 90, resizable: false }, { name: 'LeadSource', width: 90, resizable: false },
                    { name: 'focus', width: 50, resizable: false },
                    { name: 'flag', width: 45, resizable: false },
                    { name: 'assignto', width: 100, resizable: false },
                    ...
                    { name: 'leadfeedback ', lable: 'leadfeedback', width: 250, resizable: false, formatter: leadFeedBack }
                ],
                            viewrecords: true, height: 'auto', width: 1060, rowNum: 20, rowList: [20, 30, 50, 100], shrinkToFit: true, pager: "#jqGridPager",
        ...
        function SelectSingleReview(rdBtnID) {
            ...
            TINY.box.show({ iframe: 'prospectpopup.aspx?custcode=' + rdBtnID + '&qstr=prospectreviewdom&focus=' + focus + '&flag=' + flag + '&querystr=' + querystr, boxid: 'frameless', width: 970, height: 600, fixed: false, maskid: '#57565A', maskopacity: 40, closejs: function () { } })
        }
    </script>
</asp:Content>
