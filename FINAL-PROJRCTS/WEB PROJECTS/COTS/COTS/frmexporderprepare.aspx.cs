...
namespace COTS
{
    public partial class frmexporderprepare : System.Web.UI.Page
    {
        ...
        protected void btnNext_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    sp1[6] = new SqlParameter("@PackingMethod", "");
                    sp1[7] = new SqlParameter("@PackingOthers", "");
                    ...
                    sp1[17] = new SqlParameter("@FreightCharges", "");
                    sp1[18] = new SqlParameter("@DeliveryMethod", "");
                    sp1[19] = new SqlParameter("@GodownName", "");
                    sp1[20] = new SqlParameter("@TransportDetails", "");
                    sp1[21] = new SqlParameter("@SpecialRequset", "");
                    sp1[22] = new SqlParameter("@username", Session["cotsuser"].ToString());
                    sp1[23] = new SqlParameter("@ModeOfTransport", "");
                    ...
                    if (resp > 0)
                    {
                        ...
                        else
                        {
                            if (Session["cotscode"].ToString() == "2642")
                                Response.Redirect("frmexporder.aspx?qno=" + Utilities.Encrypt(txtOrderRefNo.Text) + "&qtype=" + Utilities.Encrypt("new"), false);
                            else
                                Response.Redirect("frmexpitementry.aspx?qno=" + Utilities.Encrypt(txtOrderRefNo.Text) + "&qtype=" + Utilities.Encrypt("new"), false);
                        }
                    }
                }
            }
