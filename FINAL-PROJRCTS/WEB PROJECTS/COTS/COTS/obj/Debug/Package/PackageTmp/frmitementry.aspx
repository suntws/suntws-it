<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true"
    CodeBehind="frmitementry.aspx.cs" Inherits="COTS.frmitementry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="contPage">
        <table cellspacing="0" rules="all" border="1" style="background-color: #ffffff; width: 100%;
            ...
            <tr>
                <td>
                    ORDER NO. :
                    <asp:Label runat="server" ID="lblOrderRefNo" ClientIDMode="Static" Text="" Font-Bold="true"
            ...
            <tr>
                <td style="text-align: center;">
                    <a id="tempInsert" class="btn btn-info" onclick="CompleteOrderEntryItems();" style="width: 140px;">
                        SAVE QTY ENTRY</a>
                </td>
                <td style="text-align: center;">
    ...
    <script type="text/javascript">
        ...
        function CompleteOrderEntryItems() {
            ...
            //Move to profoma
            $('#tempInsert').fadeOut(1000);
            $('#btnComplete').fadeIn(5000);
        }

        function display_divs(displayVal, divType) {
            $('#div' + divType + 'entry').css({ 'display': '' + displayVal + '' });
        }
    </script>
</asp:Content>
