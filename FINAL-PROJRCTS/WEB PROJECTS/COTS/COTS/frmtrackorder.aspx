                ...
                <td>
                    <asp:GridView runat="server" ID="gv_TrackOrderList" AutoGenerateColumns="false" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="EX-FACTORY SHIP DATE" DataField="RFD_DATE" />
                            <asp:BoundField HeaderText="DOC DATE" DataField="DispatchedDate" />
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#<%=gv_TrackOrderList.ClientID%> tr:has(td)").each(function () {
                if ($(this).find("td:eq(9)").html() == "ORDER SHIPPED" || $(this).find("td:eq(9)").html() == "SHIPPED OUT")
                    $(this).find("td:eq(9)").css({ "background-color": "#e9fd81" });
                else if ($(this).find("td:eq(9)").html() == "DISPATCHED" || $(this).find("td:eq(9)").html() == "DESTINATION REACHED")
