...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                                    ...
                                    <tr>
                                        <td style="background-color: #F1CED5;">
                                            <div style="float: left; background-color: #ccc; width: 75px;">
                                                <asp:CheckBox runat="server" ID="chkCGST" ClientIDMode="Static" Checked="false" 
                                                    Text="CGST %" oncheckedchanged="chkCGST_CheckedChanged" />
                                            </div>
                                        ...
                                        <td style="background-color: #BCE0B8;">
                                            <div style="float: left; background-color: #ccc; width: 75px;">
                                                <asp:CheckBox runat="server" ID="chkSGST" ClientIDMode="Static" Checked="false" 
                                                    Text="SGST %" oncheckedchanged="chkSGST_CheckedChanged" /></div>
    ...
    <script type="text/javascript">
        ...
        function CntrlSave() {
            ...
            Shipid != 11429 && Shipid != 11432 && Shipid != 4616) {
