                ...
                if (!IsPostBack)
                {
                    ...
                    if (Request.Cookies["TTSUser"] != null && Request.Cookies["TTSUser"].Value != "")
                    {
                        ...
                        if (dtuserlevel != null && dtuserlevel.Rows.Count > 0)
                        {
                            ...
                            if (Request.Cookies["TTSUser"].Value.ToLower() == "somu" || Request.Cookies["TTSUser"].Value.ToLower() == "admin")
                            {
                            ...
                            //*********************************************************************
                            if ((Request.Cookies["TTSUser"].Value.ToLower() == "admin") || Request.Cookies["TTSUser"].Value.ToLower() == "bhargav_std")
                            {
                                menuAppend.Append("<li><a href=\"#\">Accounts And Finance</a><ul>");
                                menuAppend.Append("<li><a href=\"DcPrepartion.aspx\">DC Preparation</a></li>");
                                menuAppend.Append("<li><a href=\"currentdebosters.aspx\">Debtors</a></li>");
                                menuAppend.Append("</ul></li>");
                            ...
                            //menuAppend.Append("<li><a href=\"changePassword.aspx\">Internal Actions</a></li>");//to be deleted
        ...
        private void Build_DashBoard_MenuList(StringBuilder menuAppend, DataTable dt, string strImg)
        {
            try
            {
                    ...
                    || dt.Rows[0]["dwg_download"].ToString() == "True")
                {
                    ...
                    if (dt.Rows[0]["dc_mmn"].ToString() == "True")
                    {
                        menuAppend.Append("<li><a href=\"DcPrepartion.aspx\">INTERNALDCMMN</a></li>");
                    }
                    ...
                    if (dt.Rows[0]["stock_report"].ToString() == "True")
                    {
                       ...
                       // if (Request.Cookies["TTSUser"].Value.ToLower() != "anbarasan")
                        {
                    ...
                    if (dt.Rows[0]["Tally_Type_Cost"].ToString() == "True")
                    //if (Request.Cookies["TTSUser"].Value.ToLower() == "somu" || Request.Cookies["TTSUser"].Value.ToLower() == "admin" ||
            ...
            try
            {
                    ...
                    || dt.Rows[0]["dom_pdi_pdk_approval"].ToString() == "True")
                {
                    ...
                    if (dt.Rows[0]["dom_proforma"].ToString() == "True" || dt.Rows[0]["dom_substitution"].ToString() == "True" || dt.Rows[0]["dom_paymentconfirm"].ToString() == "True"
                        ...
                        || dt.Rows[0]["ot_qcmmn"].ToString() == "True" || dt.Rows[0]["ot_qcpdk"].ToString() == "True" || dt.Rows[0]["dom_pdi_mmn_approval"].ToString() == "True"
                        || dt.Rows[0]["dom_pdi_pdk_approval"].ToString() == "True" || dt.Rows[0]["dom_earmark_mmn"].ToString() == "True" || dt.Rows[0]["dom_earmark_pdk"].ToString() == "True" || dt.Rows[0]["dom_load_mmn"].ToString() == "True")
                    {
                        ...
                        if (dt.Rows[0]["dom_pdi_mmn"].ToString() == "True" || dt.Rows[0]["dom_pdi_mmn_approval"].ToString() == "True" || dt.Rows[0]["dom_load_mmn"].ToString() == "True")
                        {
                            ...
                            if (dt.Rows[0]["dom_load_mmn"].ToString() == "True")
                            {
            ...
            try
            {
                    ...
                    || dt.Rows[0]["prod_approval_pdk"].ToString() == "True")
                {
                    ...
                    if (dt.Rows[0]["exp_proforma"].ToString() == "True" || dt.Rows[0]["exp_substitution"].ToString() == "True" || dt.Rows[0]["exp_documents"].ToString() == "True"
                        || dt.Rows[0]["exp_pdi_mmn"].ToString() == "True" || dt.Rows[0]["exp_load_mmn"].ToString() == "True" || dt.Rows[0]["exp_pdi_sltl"].ToString() == "True" || dt.Rows[0]["exp_pdi_sitl"].ToString() == "True"
                        ...
                        || dt.Rows[0]["prod_approval_sitl"].ToString() == "True" || dt.Rows[0]["prod_approval_pdk"].ToString() == "True" || dt.Rows[0]["exp_load_mmn"].ToString() == "True")
                    {
                        menuAppend.Append("<li><a href=\"#\">Order Process</a><ul>");
                        ...
                        if (dt.Rows[0]["ot_ppc_sltl"].ToString() == "True")
                        {
                            ...
                            if (Request.Cookies["TTSUser"].Value.ToLower() == "admin")
                            {
                                ...
                                menuAppend.Append("<li><a href=\"expppc_verification1.aspx?pid=" + Utilities.Encrypt("SLTL") + "&fid=" + Utilities.Encrypt("e") +
                                "\">RFD Assign</a></li>");
                        ...
                        if (dt.Rows[0]["ot_ppc_sitl"].ToString() == "True")
                        {
                            ...
                            if (Request.Cookies["TTSUser"].Value.ToLower() == "admin")
                            {
                                ...
                                menuAppend.Append("<li><a href=\"expppc_verification1.aspx?pid=" + Utilities.Encrypt("SITL") + "&fid=" + Utilities.Encrypt("e") +
                                "\">RFD Assign</a></li>");
                        ...
                        if (dt.Rows[0]["exp_pdi_mmn"].ToString() == "True" || dt.Rows[0]["exp_pdi_mmn_approval"].ToString() == "True" || dt.Rows[0]["exp_load_mmn"].ToString() == "True")
                        {
                            menuAppend.Append("<li><a href=\"#\">PDI MMN</a><ul>");
                            ...
                            if (dt.Rows[0]["exp_load_mmn"].ToString() == "True")
                            {
                    ...
                    if (dt.Rows[0]["exp_usermaster"].ToString() == "True")
                    {
                        ...
                        menuAppend.Append("<li><a href=\"PriceSheetCreation.aspx\">Pricesheetcreation</a></li>");
            ...
            try
            {
                    ...
                    || dt.Rows[0]["prospect_reviewexp"].ToString() == "True" || dt.Rows[0]["prospect_reviewdom"].ToString() == "True")
                {
                    ...
                    if (Request.Cookies["TTSUser"].Value.ToLower() == "admin" || Request.Cookies["TTSUser"].Value.ToLower() == "somu")// ||
                       // Request.Cookies["TTSUser"].Value.ToLower() == "admin")
                    {
