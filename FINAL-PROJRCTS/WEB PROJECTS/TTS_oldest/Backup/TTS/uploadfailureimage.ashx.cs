...
{
    /// <summary>
    /// Summary description for uploadfailureimage
    /// </summary>
    public class uploadfailureimage : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
                        ...
                        for (int z = 0; z < context.Request.Files.Count; z++)
                        {
                            ...
                            if (file1.Exists)
                            {
                                ...
                                if (strName != strrename)
                                    Directory.Move(strsave, serverURL + "/claimimages/" + strClaimCode + "/" + strClaimNo + "/" + strClaimStencil + "/" + strrename);
                            }
                        }
                    }
                    else
