...
namespace TTS
{
    public partial class claimclosed : System.Web.UI.Page
    {
        ...
        protected void SaveLRNo_Click(object sender, EventArgs e)
        {
            try
            {
                    int resp =0;
					...
					new SqlParameter("@custcode", hdnCustCode.Value),
					 new SqlParameter("@complaintno", lblClaimNo.Text),				
					 new SqlParameter("@lrno", TextBox1.Text ),
            };  
                   
                    resp = daCOTS.ExecuteNonQuery_SP("sp_update_lrno_ClaimReplacementDetails", sp10);
